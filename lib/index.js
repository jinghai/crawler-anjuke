                ...
                if (!doc) {
                    ...
                    if (allowUpdate) {
                        if(mergeFields && _.isArray(mergeFields)){
                            _.forEach(mergeFields,function(f,i){
                                data[f] = util.mergeString(doc[f],data[f]);
                            });
                        }
