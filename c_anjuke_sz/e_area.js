...
var extractor = {
    //表名
    name: '安居客_苏州_板块均价',//板块
    //  网页是否由它处理的依据，如匹配区域网址 http[s]://suzhou.anjuke.com/market[/]...
    target: /^http:\/\/suzhou\.anjuke\.com\/market(\/?)/g,
    //target: /^http:\/\/suzhou\.anjuke\.com\/market\/$/i,
    //正则，加入爬取队列，只为寻找target
    //helpUrl:/^http:\/\/suzhou\.anjuke\.com\/market(\/?)/i,
    schema: {
        url: String,
    ...
    handler: function ($, queueItem, responseBuffer, response) {
        ...
        //http://suzhou.anjuke.com/market/lingangxincheng/
