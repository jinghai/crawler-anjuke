 ...
 */
var homePage = /^http:\/\/suzhou\.anjuke\.com\/$/,//首页
    listPage = /^http:\/\/su\.sp\.anjuke\.com\/zu(\/?|\/p\d+\/)$/,//列表页
    targetPage = /^http:\/\/su\.sp\.anjuke\.com\/zu\/(\d+\/$|\d+\/\?pt=\d+$)/;//目标页
var extractor = {
    name: '安居客_苏州_商铺出租',
    //  http://su.sp.anjuke.com/zu/33858491/
    //target: /^http:\/\/su\.sp\.anjuke\.com\/zu\/(\d+)\/$/,
    // http://su.sp.anjuke.com/zu/ http://su.sp.anjuke.com/zu/p2
    //helpUrl:/^http:\/\/su\.sp\.anjuke\.com\/zu(\/?|\/p\d+)$/,
    target: [
        homePage,
        listPage,
        targetPage,
    ...
    targetPage: function ($, queueItem) {
        //http://su.sp.anjuke.com/zu/33922059/
